...
def main():
    ...
    # Plotting
    save_directory = "one-noise-masking-bothside_plot"
    ...
    plt.xlabel('Threshold')
    plt.ylabel('Accuracy')
    plt.title('Effect of Noise Addition to Eye Regions in both image on Face Recognition Accuracy Across Thresholds')
    plt.legend()
    plt.grid(True)
