...
def main():
    ...
    # Plotting
    save_directory = "one-threshold-random-noise-bothside_plot"
    ...
    plt.xlabel('Threshold')
    plt.ylabel('Accuracy')
    plt.title('Effect of random square of noise adding in both image on Face Authentication Accuracy Across Different Thresholds')
    plt.legend()
    plt.grid(True)
