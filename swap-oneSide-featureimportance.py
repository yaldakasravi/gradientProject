...
def preprocess_image(image_path, apply_mask, num_squares=0, square_size=20):
    ...
    if apply_mask and num_squares > 0:
        # Select a different person's image for swapping
...
def main():
    ...
    save_directory = "swapping_different_persons_oneSide_impact_features_importance"
    ...
    for mask_thickness in mask_thickness_levels:
        ...
        for threshold in thresholds:
            ...
            for pairs_file in pairs_files:
                dataset = prepare_dataset(pairs_file, int(mask_thickness * 10), 20)  # Mask with different person's image
