...
experiment = Experiment(api_key="UuHTEgYku8q9Ww3n13pSEgC8d", project_name="swapping-sameperson-oneside_effect", workspace="enhancing-gradient")
...
def main():
    ...
    # Plotting
    save_directory = "one-swap-same-person-one-sides_plot"
    ...
    plt.ylabel('Accuracy')
    plt.title('Effect of swapping eyes with same person on one of the Images')
