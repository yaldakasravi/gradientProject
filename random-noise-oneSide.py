...
def main():
    ...
    # Plotting
    save_directory = "one-threshold-random-noise-oneside_plot"
    ...
    plt.xlabel('Threshold')
    plt.ylabel('Accuracy')
    plt.title('Effect of adding random square noise on one image on Face Authentication Accuracy Across Different Thresholds')
    plt.legend()
    plt.grid(True)
