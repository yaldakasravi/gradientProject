...
experiment = Experiment(api_key="UuHTEgYku8q9Ww3n13pSEgC8d", project_name="swap-lowerFeatures_impact", workspace="enhancing-gradient")
...
def main():
    ...
    save_directory = "samePersonSwap_impact_on_lower_features"
    ...
    for mask_thickness in mask_thickness_levels:
        ...
        for threshold in thresholds:
            ...
            for pairs_file in pairs_files:
                dataset = prepare_dataset(pairs_file, int(mask_thickness * 10), 20, "lower")  # Mask the lower third
    ...
    plt.title("Accuracy vs. Threshold for Different Mask Thicknesses on Lower Face")
